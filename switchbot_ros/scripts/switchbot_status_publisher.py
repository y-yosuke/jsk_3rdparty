...
from switchbot_ros.switchbot_ros_status_client import SwitchBotROSStatusClient
...
class SwitchBotStatusPublisher:
    ...
    """
    def __init__(self):
        # Initialize SwitchBot ROS Status Client
        self.client = SwitchBotROSStatusClient()
